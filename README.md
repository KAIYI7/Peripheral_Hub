...
## What I Learned
- Building server-rendered web apps using Web Forms (UI + code-behind)
- Connecting to a relational DB using ADO.NET
- Implementing e-commerce flows (cart, checkout totals, invoices)
- Admin CRUD with file upload and DB update
- Using session-based access control for protected pages
