<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="PeripheralHub.Admin" %>
...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
    <form id="form1" runat="server">
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand"><img src="Images/peripheralhub-high-resolution-logo-transparent.png" alt="logo" style="width:91px;height:35px;"/></a>
                </div>
        ...
        <div id="SingIN" class="bg-1">
            ...
            <p class="text-center">Connect with your <a href="SignIn.aspx"><strong>Client Account ?</strong></a></p>
                <div class="row">
                    <div class="col-md-3">
        ...
        <footer class="text-center">
            ...
            <br/>
            <br/>
            <p>Contact Developer <a href="mailto:klax670@gmail.com" data-toggle="tooltip" title="Contact Developper">klax670@gmail.com</a></p>
        </footer>
