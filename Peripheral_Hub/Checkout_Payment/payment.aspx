<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="eCommerce_ASP.Net.Checkout_Payment.payment" %>
...
<body>
    <form runat="server">
        <header>
            <div id="linesdiv">
                <div class="hrdiv" id="deliverynavdiv">
                    <p>DELIVERY</p>
                    <hr />
                </div>
                <div class="highlight hrdiv" id="paymentnavdiv">
                    <p>PAYMENT</p>
                    <hr />
                </div>
            </div>
                        ...
                        <div class="card-container">
                            ...
                            <div class="back">
                                ...
                                <div class="mbox">
                                    ...
                                    <img src="../Images/visa_logo.png" alt="visaLogo">
                                </div>
                            </div>
